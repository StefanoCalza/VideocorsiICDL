            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li > <form action="goEsami" method="post"> <input type="submit" style="border:0px; background:white;" value="ESAMI&nbsp&nbsp"> <p th:text=" ${errorMsg}"></p> </form> </li>
                     <li > <form action="GetPassedExam" method="GET"> <input type="submit" style="border:0px; background:white;" value="ESAMI PASSATI&nbsp&nbsp"> <p th:text=" ${errorMsg}"></p> </form> </li>
...
<section class="clean-block clean-info dark" style="padding: 70px;">
        <div class="container">
            ...
            <div class="row align-items-center">
                    ...
                    <form method="get" action="Iscriviti" enctype="multipart/form-data">
